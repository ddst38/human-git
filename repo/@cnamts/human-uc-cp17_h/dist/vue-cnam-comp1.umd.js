(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["vue-cnam-comp1"] = factory();
	else
		root["vue-cnam-comp1"] = factory();
...
__webpack_require__.d(__webpack_exports__, {
  BeneficiaireApi: function() { return /* reexport */ BeneficiaireApi; },
  BeneficiaireApiAxiosParamCreator: function() { return /* reexport */ BeneficiaireApiAxiosParamCreator; },
  BeneficiaireApiFactory: function() { return /* reexport */ BeneficiaireApiFactory; },
  BeneficiaireApiFp: function() { return /* reexport */ BeneficiaireApiFp; },
...
var es_object_proto = __webpack_require__(9330);
...
var es_array_find = __webpack_require__(5728);
...
;// CONCATENATED MODULE: ./node_modules/@cnamts/human-uc-oa17_h/src/base.ts
...
var BASE_PATH = "http://localhost:9001/uc-ctrl-rest-openapi/public/rest".replace(/\/+$/, "");
/**
 *
 * @export
 */
...
;// CONCATENATED MODULE: ./node_modules/@cnamts/human-uc-oa17_h/src/common.ts
...
var assertParamExists = function assertParamExists(functionName, paramName, paramValue) {
  if (paramValue === null || paramValue === undefined) {
    throw new RequiredError(paramName, "Required parameter ".concat(paramName, " was null or undefined when calling ").concat(functionName, "."));
  }
};
/**
 *
 * @export
 */
var setApiKeyToObject = function setApiKeyToObject(object, keyParamName, configuration) {
    ...
    return __generator(this, function (_b) {
      switch (_b.label) {
        ...
        case 1:
          ...
          return [3 /*break*/, 4];
        case 2:
          return [4 /*yield*/, configuration.apiKey];
        case 3:
          _a = _b.sent();
          _b.label = 4;
        case 4:
 ...
 * @export
 */
var setBearerAuthToObject = function setBearerAuthToObject(object, configuration) {
  return __awaiter(this, void 0, void 0, function () {
    var accessToken, _a;
    return __generator(this, function (_b) {
      switch (_b.label) {
 ...
 * @export
 */
var setOAuthToObject = function setOAuthToObject(object, name, scopes, configuration) {
  return __awaiter(this, void 0, void 0, function () {
...
;// CONCATENATED MODULE: ./node_modules/@cnamts/human-uc-oa17_h/src/api.ts
 ...
 * Do not edit the class manually.
 */
var api_extends = undefined && undefined.__extends || function () {
  var _extendStatics = function extendStatics(d, b) {
    _extendStatics = Object.setPrototypeOf || {
      __proto__: []
    } instanceof Array && function (d, b) {
 ...
 * @export
 */
var BeneficiaireApiAxiosParamCreator = function BeneficiaireApiAxiosParamCreator(configuration) {
  var _this = this;
  return {
    /**
     *
     ...
     * @throws {RequiredError}
     */
    _delete: function _delete(id, options) {
      if (options === void 0) {
        options = {};
      }
      return api_awaiter(_this, void 0, Promise, function () {
        ...
        return api_generator(this, function (_a) {
          switch (_a.label) {
            case 0:
              ...
              localVarPath = "/beneficiaires/{id}".replace("{".concat("id", "}"), encodeURIComponent(String(id)));
              localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
              if (configuration) {
                baseOptions = configuration.baseOptions;
              }
              localVarRequestOptions = api_assign(api_assign({
                method: 'DELETE'
              }, baseOptions), options);
            ...
            case 1:
              ...
              localVarRequestOptions.headers = api_assign(api_assign(api_assign({}, localVarHeaderParameter), headersFromBaseOptions), options.headers);
              return [2 /*return*/, {
     ...
     * @throws {RequiredError}
     */
    create: function create(beneficiaireResource, options) {
      if (options === void 0) {
        options = {};
      }
      return api_awaiter(_this, void 0, Promise, function () {
     ...
     * @throws {RequiredError}
     */
    find: function find(matricule, dateNaissance, rang, options) {
      if (options === void 0) {
        options = {};
      }
      return api_awaiter(_this, void 0, Promise, function () {
          ...
          switch (_a.label) {
            ...
            case 1:
              ...
              if (dateNaissance !== undefined) {
                localVarQueryParameter['date-naissance'] = dateNaissance instanceof Date ? dateNaissance.toISOString().substr(0, 10) : dateNaissance;
              }
              if (rang !== undefined) {
     ...
     * @throws {RequiredError}
     */
    replace: function replace(id, beneficiaireResource, options) {
      if (options === void 0) {
        options = {};
      }
      return api_awaiter(_this, void 0, Promise, function () {
     ...
     * @throws {RequiredError}
     */
    update: function update(beneficiaireResource, options) {
      if (options === void 0) {
        options = {};
      }
      return api_awaiter(_this, void 0, Promise, function () {
 ...
 * @export
 */
var BeneficiaireApiFp = function BeneficiaireApiFp(configuration) {
  var localVarAxiosParamCreator = BeneficiaireApiAxiosParamCreator(configuration);
  return {
    /**
     *
     * @summary Supprime un bénéficiaire identifié par son id.
     ...
     */
    _delete: function _delete(id, options) {
      return api_awaiter(this, void 0, Promise, function () {
        var localVarAxiosArgs;
        return api_generator(this, function (_a) {
          switch (_a.label) {
            case 0:
              return [4 /*yield*/, localVarAxiosParamCreator._delete(id, options)];
            case 1:
              localVarAxiosArgs = _a.sent();
              return [2 /*return*/, createRequestFunction(localVarAxiosArgs, (axios_default()), BASE_PATH, configuration)];
          }
        });
      });
    },
    ...
    create: function create(beneficiaireResource, options) {
      return api_awaiter(this, void 0, Promise, function () {
        ...
        return api_generator(this, function (_a) {
          switch (_a.label) {
            case 0:
              return [4 /*yield*/, localVarAxiosParamCreator.create(beneficiaireResource, options)];
            case 1:
              localVarAxiosArgs = _a.sent();
              return [2 /*return*/, createRequestFunction(localVarAxiosArgs, (axios_default()), BASE_PATH, configuration)];
          }
    ...
    find: function find(matricule, dateNaissance, rang, options) {
      return api_awaiter(this, void 0, Promise, function () {
        ...
        return api_generator(this, function (_a) {
          switch (_a.label) {
            case 0:
              return [4 /*yield*/, localVarAxiosParamCreator.find(matricule, dateNaissance, rang, options)];
            case 1:
              localVarAxiosArgs = _a.sent();
              return [2 /*return*/, createRequestFunction(localVarAxiosArgs, (axios_default()), BASE_PATH, configuration)];
          }
    ...
    read: function read(id, options) {
      return api_awaiter(this, void 0, Promise, function () {
        ...
        return api_generator(this, function (_a) {
          switch (_a.label) {
            case 0:
              return [4 /*yield*/, localVarAxiosParamCreator.read(id, options)];
            case 1:
              localVarAxiosArgs = _a.sent();
              return [2 /*return*/, createRequestFunction(localVarAxiosArgs, (axios_default()), BASE_PATH, configuration)];
          }
    ...
    replace: function replace(id, beneficiaireResource, options) {
      return api_awaiter(this, void 0, Promise, function () {
        ...
        return api_generator(this, function (_a) {
          switch (_a.label) {
            case 0:
              return [4 /*yield*/, localVarAxiosParamCreator.replace(id, beneficiaireResource, options)];
            case 1:
              localVarAxiosArgs = _a.sent();
              return [2 /*return*/, createRequestFunction(localVarAxiosArgs, (axios_default()), BASE_PATH, configuration)];
          }
    ...
    update: function update(beneficiaireResource, options) {
      return api_awaiter(this, void 0, Promise, function () {
        ...
        return api_generator(this, function (_a) {
          switch (_a.label) {
            case 0:
              return [4 /*yield*/, localVarAxiosParamCreator.update(beneficiaireResource, options)];
            case 1:
              localVarAxiosArgs = _a.sent();
              return [2 /*return*/, createRequestFunction(localVarAxiosArgs, (axios_default()), BASE_PATH, configuration)];
          }
 ...
 * @export
 */
var BeneficiaireApiFactory = function BeneficiaireApiFactory(configuration, basePath, axios) {
  var localVarFp = BeneficiaireApiFp(configuration);
  return {
    /**
     *
     * @summary Supprime un bénéficiaire identifié par son id.
     ...
     */
    _delete: function _delete(id, options) {
      return localVarFp._delete(id, options).then(function (request) {
     ...
     */
    create: function create(beneficiaireResource, options) {
      return localVarFp.create(beneficiaireResource, options).then(function (request) {
        return request(axios, basePath);
      });
    },
    /**
     ...
     */
    find: function find(matricule, dateNaissance, rang, options) {
      return localVarFp.find(matricule, dateNaissance, rang, options).then(function (request) {
        return request(axios, basePath);
      });
    },
    /**
     ...
     */
    read: function read(id, options) {
      return localVarFp.read(id, options).then(function (request) {
        return request(axios, basePath);
      });
    },
    /**
     ...
     */
    replace: function replace(id, beneficiaireResource, options) {
      return localVarFp.replace(id, beneficiaireResource, options).then(function (request) {
        return request(axios, basePath);
      });
    },
    /**
     ...
     */
    update: function update(beneficiaireResource, options) {
      return localVarFp.update(beneficiaireResource, options).then(function (request) {
        return request(axios, basePath);
      });
    }
  };
 ...
 * @extends {BaseAPI}
 */
var BeneficiaireApi = /** @class */function (_super) {
  api_extends(BeneficiaireApi, _super);
   ...
   */
  BeneficiaireApi.prototype._delete = function (id, options) {
    var _this = this;
    return BeneficiaireApiFp(this.configuration)._delete(id, options).then(function (request) {
   ...
   * @memberof BeneficiaireApi
   */
  BeneficiaireApi.prototype.create = function (beneficiaireResource, options) {
    var _this = this;
    return BeneficiaireApiFp(this.configuration).create(beneficiaireResource, options).then(function (request) {
      return request(_this.axios, _this.basePath);
    });
  };
  /**
   ...
   * @memberof BeneficiaireApi
   */
  BeneficiaireApi.prototype.find = function (matricule, dateNaissance, rang, options) {
    var _this = this;
    return BeneficiaireApiFp(this.configuration).find(matricule, dateNaissance, rang, options).then(function (request) {
      return request(_this.axios, _this.basePath);
    });
  };
  /**
   ...
   * @memberof BeneficiaireApi
   */
  BeneficiaireApi.prototype.read = function (id, options) {
    var _this = this;
    return BeneficiaireApiFp(this.configuration).read(id, options).then(function (request) {
      return request(_this.axios, _this.basePath);
    });
  };
  /**
   ...
   * @memberof BeneficiaireApi
   */
  BeneficiaireApi.prototype.replace = function (id, beneficiaireResource, options) {
    var _this = this;
    return BeneficiaireApiFp(this.configuration).replace(id, beneficiaireResource, options).then(function (request) {
      return request(_this.axios, _this.basePath);
    });
  };
  /**
   ...
   * @memberof BeneficiaireApi
   */
  BeneficiaireApi.prototype.update = function (beneficiaireResource, options) {
    var _this = this;
    return BeneficiaireApiFp(this.configuration).update(beneficiaireResource, options).then(function (request) {
      return request(_this.axios, _this.basePath);
    });
  };
  return BeneficiaireApi;
}(BaseAPI);
...
;// CONCATENATED MODULE: ./node_modules/@cnamts/human-uc-oa17_h/src/configuration.ts
...
;// CONCATENATED MODULE: ./node_modules/@cnamts/human-uc-oa17_h/src/index.ts
/* tslint:disable */
/* eslint-disable */
/**
 * Beneficiaires
...
var _typeof = (__webpack_require__(5717)["default"]);
...
var vue_1 = __importDefault(__webpack_require__(144));
var vue_class_component_1 = __importDefault(__webpack_require__(5904));
var src_1 = __webpack_require__(2720);
...
var BeneficiaireComp = /** @class */function (_super) {
  __extends(BeneficiaireComp, _super);
  function BeneficiaireComp() {
    ...
    _this.configuration = new src_1.Configuration({
      basePath: '.'
    });
    _this.postsApi = (0, src_1.BeneficiaireApiFactory)(_this.configuration, undefined, _this.axiosInstance);
    _this.resultat = 'veuillez cliquer sur le bouton';
    _this.success = false;
    _this.launch = false;
    return _this;
  }
  BeneficiaireComp.prototype.helloThere = function () {
    var _this = this;
    // {"value":{"id":1,"matricule":"1990197000001","date-naissance":"1999-01-31","rang":1,"nom":"Martini","prenom":"Rossé"}}
    var promise = this.postsApi.read(1);
    promise.then(function (beneficiaire) {
      _this.resultat = beneficiaire.data.value.prenom + ' ' + beneficiaire.data.value.nom;
      _this.launch = true;
      _this.success = true;
  ...
  BeneficiaireComp = __decorate([(0, vue_class_component_1.default)({})], BeneficiaireComp);
  return BeneficiaireComp;
}(Props);
exports["default"] = BeneficiaireComp;
...
var fails = __webpack_require__(3689);
var toIndexedObject = __webpack_require__(5290);
var nativeGetOwnPropertyDescriptor = (__webpack_require__(2474).f);
var DESCRIPTORS = __webpack_require__(7697);
...
var hasOwn = __webpack_require__(6812);
var assign = __webpack_require__(5394);
var arrayFrom = __webpack_require__(1055);
var arraySlice = __webpack_require__(9015);
var codeAt = (__webpack_require__(730).codeAt);
...
/* harmony default export */ var binds_attrs = (vue_runtime_esm["default"].extend({
  data: () => ({
    attrs$: {},
    listeners$: {}
  }),
...
class Theme extends Service {
  ...
  initTheme(root) {
    ...
    root.$once('hook:created', () => {
      const obs = vue_runtime_esm["default"].observable({
        themes: this.themes
      });
...
/* harmony default export */ var colorable = (vue_runtime_esm["default"].extend({
  name: 'colorable',
  props: {
    color: String
  },
...
/* harmony default export */ var elevatable = (vue_runtime_esm["default"].extend({
  name: 'elevatable',
  props: {
...
/* harmony default export */ var measurable = (vue_runtime_esm["default"].extend({
  name: 'measurable',
  props: {
...
/* harmony default export */ var roundable = (vue_runtime_esm["default"].extend({
  name: 'roundable',
  props: {
...
const Themeable = vue_runtime_esm["default"].extend().extend({
  name: 'themeable',
...
/* harmony default export */ var VSheet = (mixins(binds_attrs, colorable, elevatable, measurable, roundable, themeable).extend({
  name: 'v-sheet',
  props: {
    outlined: Boolean,
    shaped: Boolean,
...
//# sourceMappingURL=index.js.map
;// CONCATENATED MODULE: ./node_modules/vuetify/src/components/VProgressCircular/VProgressCircular.sass
// extracted by mini-css-extract-plugin
...
/* harmony default export */ var VProgressCircular = (colorable.extend({
...
/* harmony default export */ var toggleable = ((/* unused pure expression or super */ null && (Toggleable)));
//# sourceMappingURL=index.js.map
...
const VIcon = mixins(binds_attrs, colorable, sizeable, themeable
/* @vue/component */
).extend({
  name: 'v-icon',
  props: {
...
/* harmony default export */ var VChip = (mixins(colorable, sizeable, routable, themeable, factory('chipGroup'), toggleable_factory('inputValue')).extend({
  name: 'v-chip',
  props: {
    active: {
      type: Boolean,
...
;// CONCATENATED MODULE: ./node_modules/vuetify-loader/lib/loader.js??ruleSet[1].rules[0].use!./node_modules/babel-loader/lib/index.js??clonedRuleSet-85.use[1]!./node_modules/@vue/vue-loader-v15/lib/loaders/templateLoader.js??ruleSet[1].rules[5]!./node_modules/@vue/vue-loader-v15/lib/index.js??vue-loader-options!./src/elements/Beneficiaire/BeneficiaireComp.vue?vue&type=template&id=4e304f0c
...
var render = function render() {
  ...
  return _c('div', [_vm._v(" Nom du bénéficiaire récupéré : " + _vm._s(_vm.resultat) + " "), _c('br'), _c(VBtn, {
    staticClass: "text-wrap mt-8",
    attrs: {
      "color": "accent",
      "height": "auto",
      "min-height": "30px"
    ...
    on: {
      "click": _vm.helloThere
    }
  }, [_vm._v(" Appeler l'api beneficiaire ")]), _c('br'), _c('br'), _vm.success && _vm.launch ? _c(VChip, {
    attrs: {
      "color": "green",
      "label": ""
    }
  }, [_vm._v(" TEST EFFECTUE AVEC SUCCES ")]) : _vm._e(), !_vm.success && _vm.launch ? _c(VChip, {
    attrs: {
      "color": "red",
      "label": ""
    }
  }, [_vm._v(" TEST EN ERREUR ")]) : _vm._e()], 1);
};
var staticRenderFns = [];

// EXTERNAL MODULE: ./node_modules/thread-loader/dist/cjs.js!./node_modules/babel-loader/lib/index.js!./node_modules/ts-loader/index.js??clonedRuleSet-86.use[2]!./node_modules/@vue/vue-loader-v15/lib/index.js??vue-loader-options!./src/elements/Beneficiaire/BeneficiaireComp.vue?vue&type=script&lang=ts
var BeneficiaireCompvue_type_script_lang_ts = __webpack_require__(6762);
var BeneficiaireCompvue_type_script_lang_ts_default = /*#__PURE__*/__webpack_require__.n(BeneficiaireCompvue_type_script_lang_ts);
;// CONCATENATED MODULE: ./src/elements/Beneficiaire/BeneficiaireComp.vue?vue&type=script&lang=ts
 /* harmony default export */ var Beneficiaire_BeneficiaireCompvue_type_script_lang_ts = ((BeneficiaireCompvue_type_script_lang_ts_default())); 
...
;// CONCATENATED MODULE: ./src/elements/Beneficiaire/BeneficiaireComp.vue
...
var component = normalizeComponent(
  Beneficiaire_BeneficiaireCompvue_type_script_lang_ts,
  render,
  staticRenderFns,
  false,
  null,
...
/* harmony default export */ var BeneficiaireComp = (component.exports);
;// CONCATENATED MODULE: ./node_modules/@vue/cli-service/lib/commands/build/entry-lib.js


/* harmony default export */ var entry_lib = (BeneficiaireComp);
...
//# sourceMappingURL=vue-cnam-comp1.umd.js.map