...
process.env.VUE_APP_CODE_MODULE = require('./package.json').name;
process.env.VUE_APP_VERSION = require('./package.json').version + ' (sk version ' + require('./package.json').skversion + ')';
